...
<div class="container">
    <div class="row justify-content-md-center">
        <div class="videoFilm col-md-12">
            <iframe src="{{ $filmHasard->LIENBA }}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>

        <div class="col-md-12 descriptionFilm">
            <div class="hautTitre">
                <h2 id="titre">{{ $filmHasard->NOMFILM }}</h2>
            </div>
            <div class="bas">
                <div class="lesCategories">
                </div>
                <div class="leTemps">
                    <p><i class="far fa-clock"></i>Durée: {{ $filmHasard->DUREE }}</p><p id="tempsFilm"></p><p>&nbsp;minutes</p>
                </div>
            </div>
            <hr class="separateur">
            <div class="sousDescription">
                <div class="sousResumer">
                    <div class="resumer">
                        <p id="resumer"> {{ $filmHasard->RESUME }}</p>
                    </div>
                    <hr class="separateur"><i class="far fa-dot-circle"></i>
                    <div class="realisateur">
                        <p>Realisateur:</p>
                        <h5 id="realisateur"> {{ $filmHasard->NOMREAL . " " . $filmHasard->PRENOMREAL  }}</h5>
                    </div>
                    <hr class="separateur"><i class="far fa-dot-circle"></i>
                    <div class="dateSortie">
                        <p>Date de sortie:</p>
                        <h5 id="dateSortie"> {{ $filmHasard->DATESORTIE }}</h5>
                    </div>
                    <hr class="separateur"><i class="far fa-dot-circle"></i>
                </div>
            </div>
